    ...
    public partial class WndColorPicker : Window
    {
        public static DependencyProperty ColorProperty
            = DependencyProperty.Register(
                nameof(Color),
                typeof(Color),
                typeof(WndColorPicker));

        private SolidColorBrush pink = new(Colors.Pink);
        private SolidColorBrush white = new(Colors.White);
        ...
        private WndColorPicker(Color col)
        {
            InitializeComponent();
            Color = col;
