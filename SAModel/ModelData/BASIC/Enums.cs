...
namespace SATools.SAModel.ModelData.BASIC
{
    ...
    {
        private const int BIT_0 = 1 << 0;
        private const int BIT_1 = 1 << 1;
        private const int BIT_2 = 1 << 2;
        private const int BIT_3 = 1 << 3;
        private const int BIT_4 = 1 << 4;
        private const int BIT_5 = 1 << 5;
        private const int BIT_6 = 1 << 6;
        private const int BIT_7 = 1 << 7;
        private const int BIT_8 = 1 << 8;
        private const int BIT_9 = 1 << 9;
        private const int BIT_10 = 1 << 10;
        private const int BIT_11 = 1 << 11;
        private const int BIT_12 = 1 << 12;
        private const int BIT_13 = 1 << 13;
        private const int BIT_14 = 1 << 14;
        private const int BIT_15 = 1 << 15;
        private const int BIT_16 = 1 << 16;
        private const int BIT_17 = 1 << 17;
        private const int BIT_18 = 1 << 18;
        private const int BIT_19 = 1 << 19;
        private const int BIT_20 = 1 << 20;
        private const int BIT_21 = 1 << 21;
        private const int BIT_22 = 1 << 22;
        private const int BIT_23 = 1 << 23;
        private const int BIT_24 = 1 << 24;
        private const int BIT_25 = 1 << 25;
        private const int BIT_26 = 1 << 26;
        private const int BIT_27 = 1 << 27;
        private const int BIT_28 = 1 << 28;
        private const int BIT_29 = 1 << 29;
        private const int BIT_30 = 1 << 30;
        private const int BIT_31 = 1 << 31;
